...
class Kkn_merdeka extends CI_Controller
{

    public function index()
    {
        if ($this->session->level == 'admin') {
            $data['Kkn_merdeka'] = $this->Kkn_merdeka_model->tampil_data_admin('kkn_merdeka')->result();
        } else {
            $data['Kkn_merdeka'] = $this->Kkn_merdeka_model->tampil_data('kkn_merdeka', $this->session->userdata('nim'))->result();
        }


        $data['cek_nim'] = $this->Kkn_merdeka_model->tampil_data('kkn_merdeka', $this->session->userdata('nim'))->result();
        $data['title'] = "KKN Merdeka Belajar";
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_merdeka', $data);
    ...
    public function detail($id)
    {
        ...
        $data['detail'] = $this->Kkn_merdeka_model->ambil_id_kkn_merdeka($id);
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_merdeka_detail', $data);
        $this->load->view('templates_administrator/footer');
    }

    public function tambah_Kkn_merdeka()
    {
        $data['title'] = " Tambah Data";
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_merdeka_form', $data);
        $this->load->view('templates_administrator/footer');
    }


    public function tambah_Kkn_merdeka_aksi()
    {
        $this->_rules();

        if ($this->form_validation->run() == FALSE) {
            $this->tambah_Kkn_merdeka();
        } else {
            ...
            $this->Kkn_merdeka_model->insert_data($data, 'Kkn_merdeka');
            $this->session->set_flashdata('pesan_kkn_merdeka_admin', '<div class="alert alert-success alert-dismissible fade show" role="alert">
            Data berhasil ditambahkan!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times; </span>
            </button>
            </div>');
            redirect('administrator/Kkn_merdeka');
        }
    }
    ...
    {
        // $where = array('id' => $id);
        $data['title'] = "Update Data KKN Merdeka Belajar";
        $data['Kkn_merdeka'] = $this->Kkn_merdeka_model->edit_data('Kkn_merdeka', $id)->result();
        $ayam = $this->Kkn_merdeka_model->edit_data('Kkn_merdeka', $id)->result();
        // var_dump($ayam);die;
        $data['detail'] = $this->Kkn_merdeka_model->ambil_id_kkn_merdeka($id);
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_merdeka_update', $data);
        $this->load->view('templates_administrator/footer');
    }

    public function update_Kkn_merdeka_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Kkn_merdeka_model->update_data($where, $data, 'Kkn_merdeka');
            $this->session->set_flashdata('pesan_kkn_merdeka_admin', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $where = array('id' => $id);
        $this->Kkn_merdeka_model->hapus_data($where, 'Kkn_merdeka');
        $this->session->set_flashdata('pesan_kkn_merdeka_admin', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    public function downloadZip($id)
    {
        ...
        $query = $this->Kkn_merdeka_model->ambil_id_kkn_merdeka($id);
        ...
        $this->zip->download('Data Berkas KKN.zip');
    }
    public function search()
    {
        ...
        $data['Kkn_merdeka'] = $this->Kkn_merdeka_model->get_keyword($keyword);


        $data['title'] = 'search data KKN ';
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_merdeka', $data);
        $this->load->view('templates_administrator/footer');
    ...
    public function downloadExcel()
    {
        ...
        $data['kkn'] = $this->Kkn_merdeka_model->export_excel('Kkn_merdeka')->result_array();

        $this->load->view('administrator/laporan_merdeka_excel', $data);
    }

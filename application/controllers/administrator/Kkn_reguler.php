...
class Kkn_reguler extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('administrator/Kkn_reguler', $data);
    ...
    public function detail($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_reguler_detail', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function tambah_Kkn_reguler()
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_reguler_form', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function tambah_Kkn_reguler_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('pesan_kkn_reguler_admin', '<div class="alert alert-success alert-dismissible fade show" role="alert">
            Data berhasil ditambahkan!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times; </span>
            </button>
            </div>');
            redirect('administrator/Kkn_reguler');
        }
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_reguler_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function search()
    {
        ...
        $data['title'] = 'serach data KKN Reguler';
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/Kkn_reguler', $data);
        $this->load->view('templates_administrator/footer');

...
class Laporan_akhir extends CI_Controller
{
    public function index()
    {
        ...
        $this->load->view('administrator/v_laporan_akhir', $data);
    ...
    public function laporan_akhir_form()
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/laporan_akhir_form', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function laporan_akhir_save()
    {
        ...
        $this->session->set_flashdata('pesan_laporan_reguler_admin', '<div class="alert alert-success alert-dismissible fade show" role="alert">
        Data berhasil ditambahkan!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times; </span>
        </button>
        </div>');
        redirect('administrator/Laporan_akhir');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/laporan_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function search()
    {
        ...
        $config['base_url'] = site_url('/administrator/Laporan_akhir');
    ...
    public function downloadExcel()
    {
        ...
        $this->load->view('administrator/laporan_akhir_reguler_excel', $data);
    }
}

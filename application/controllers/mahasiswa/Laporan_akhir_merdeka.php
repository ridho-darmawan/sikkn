...
class Laporan_akhir_merdeka extends CI_Controller
{
    public function index()
    {
        ...
        $this->load->view('mahasiswa/v_laporan_akhir_merdeka', $data);
    ...
    public function laporan_akhir_merdeka_form()
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar_user');
        $this->load->view('mahasiswa/laporan_akhir_merdeka_form', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function laporan_akhir_merdeka_save()
    {
        ...
        $this->session->set_flashdata('pesan_laporan_merdeka', '<div class="alert alert-success alert-dismissible fade show" role="alert">
        Data berhasil ditambahkan!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times; </span>
        </button>
        </div>');
        redirect('mahasiswa/Laporan_akhir_merdeka');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar_user');
        $this->load->view('mahasiswa/laporan_akhir_merdeka_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function search()
    {
        ...
        $config['base_url'] = site_url('/mahasiswa/Laporan_akhir_merdeka');
    ...
    public function downloadExcel()
    {
        ...
        $this->load->view('mahasiswa/laporan_akhir_merdeka_excel', $data);
    }
}

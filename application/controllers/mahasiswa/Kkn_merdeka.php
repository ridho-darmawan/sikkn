...
class Kkn_merdeka extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('mahasiswa/Kkn_merdeka', $data);
    ...
    public function detail($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar_user');
        $this->load->view('mahasiswa/Kkn_merdeka_detail', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function tambah_Kkn_merdeka()
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar_user');
        $this->load->view('mahasiswa/Kkn_merdeka_form', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function tambah_Kkn_merdeka_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('pesan_kkn_merdeka', '<div class="alert alert-success alert-dismissible fade show" role="alert">
            Data berhasil ditambahkan!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times; </span>
            </button>
            </div>');
            redirect('mahasiswa/Kkn_merdeka');
        }
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_administrator/header', $data);
        $this->load->view('templates_administrator/sidebar_user');
        $this->load->view('mahasiswa/Kkn_merdeka_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function downloadZip($id)
    {
        ...
        $this->zip->download('Data Berkas KKN Merdeka Belajar.zip');
    }

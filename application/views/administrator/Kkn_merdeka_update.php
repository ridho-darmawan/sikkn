<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        <i class="fas fa-university"></i> Form Update KKN MERDEKA BELAJAR
    </div>

    <?php foreach ($Kkn_merdeka as $kknr) : ?>
        <?php echo form_open_multipart('administrator/Kkn_merdeka/update_Kkn_merdeka_aksi') ?>

    ...
    <div class="row align-items-center">
        ...
        <button class="btn btn-sm btn-warning mb-4" onclick="goBack()">Kembali</button>
            ...
            <div class="alert alert-success" role="alert">
                ...
                <i class="fas fa-university"></i> Form Edit DPL
            </div>

            <?php echo form_open_multipart('administrator/C_dpl/update');?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nip" class="form-control" value="<?php echo $dpl->nip ?>">

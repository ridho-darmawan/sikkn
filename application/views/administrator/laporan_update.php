<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        <i class="fas fa-university"></i> Form Update Laporan KKN REGULER
    </div>

    <?php foreach ($laporan as $l) : ?>
        <?php echo form_open_multipart('administrator/Laporan_akhir/update_laporan_aksi') ?>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a href="<?php echo base_url('assets/uploads/laporan/' . $l->berkas); ?>" target="blank">
                        <?= $l->berkas ?>
                    </a>
                </div>
                <div class="col-sm-9">
